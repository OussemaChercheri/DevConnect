...
export default function Login() {
  return (
    <div className='h-[100vh] flex flex-col items-center bg-background bg-cover justify-center text-white'>
      <div className=' h-[400px] w-100 bg-blue-600/20  rounded border border-blue-600/20 backdrop-blur-lg px-6 my-4'>
         <div >
           <h2 className='text-3xl font bold pb-6 text-center'>Sign in</h2>
